...
jobs:
  quality-check:
    uses: broadsage-containers/docker-ops/.github/workflows/quality-gate.yml@v0.2.5.2.5
    secrets: inherit

  security-scan:
    uses: broadsage-containers/docker-ops/.github/workflows/security-scorecard.yml@v0.2.5.2.5
    permissions:
  ...
  dependency-check:
    uses: broadsage-containers/docker-ops/.github/workflows/dependency-review.yml@v0.2.5.2.5
    secrets: inherit

  build-validate:
    uses: broadsage-containers/docker-ops/.github/workflows/pr-build-validate.yml@v0.2.5.2.5
    with:
  ...
  publish:
    ...
    uses: broadsage-containers/docker-ops/.github/workflows/pr-build-publish.yml@v0.2.5.2.5
    with:
      enable_cosign: true
...
jobs:
  community-management:
    uses: broadsage-containers/docker-ops/.github/workflows/community-management.yml@v0.2.5.2.5
    with:
