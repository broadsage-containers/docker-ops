...
jobs:
  ...
  security-scan:
    uses: broadsage-containers/docker-ops/.github/workflows/security-scorecard.yml@v0.2.6
    permissions:
  ...
  dependency-check:
    uses: broadsage-containers/docker-ops/.github/workflows/dependency-review.yml@v0.2.6
    secrets: inherit
...
jobs:
  community-management:
    uses: broadsage-containers/docker-ops/.github/workflows/community-management.yml@v0.2.6
    with:
