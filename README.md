...
jobs:
  ...
  security-scan:
    uses: broadsage-containers/docker-ops/.github/workflows/security-scorecard.yml@v0.3.0
    permissions:
...
jobs:
  community-management:
    uses: broadsage-containers/docker-ops/.github/workflows/community-management.yml@v0.3.0
    with:
